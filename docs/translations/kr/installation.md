...
다음은 최신 Gaia 버전을 설치하는 것입니다. 필요에 따라 `git checkout`을 통해 올바른 [릴리즈 버전](https://github.com/bitsongofficial/go-bitsong/releases)이 설치되어있는지 확인하세요.
...
`bitsongcli` 명령어는 다음과 비슷한 아웃풋을 내보냅니다:
