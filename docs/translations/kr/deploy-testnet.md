...
해당 문서는 `bitsongd` 노드 네트워크를 구축하는 세가지 방법을 설명합니다. 각 테스트넷 모델은 다른 테스트 목적에 최적화 되어있습니다.
...
# genesis.app_state.staking.params.bond_denom의 기본 설정은 is staking bitsongd add-genesis-account $(bitsongcli keys show validator -a) 1000stake,1000validatortoken 입니다.
