...
[Gaia](https://github.com/bitsongofficial/go-bitsong) application have been split into separate
repositories. This allows for both the Cosmos SDK and Gaia to evolve naturally
and independently. Thus, any future [releases](https://github.com/bitsongofficial/go-bitsong/releases)
...
on its current versioning path (i.e. v0.36.x ) and the [Gaia](https://github.com/bitsongofficial/go-bitsong)
application will become v2.0.x.

__[Gaia](https://github.com/bitsongofficial/go-bitsong) application v2.0.3 is
...
v2.0.3 of [Gaia](https://github.com/bitsongofficial/go-bitsong).

   **NOTE**: Go [1.13+](https://golang.org/dl/) is required!

   ```shell
   $ git clone https://github.com/bitsongofficial/go-bitsong.git && cd gaia && git checkout v2.0.3; make install
   ```
...
4. We highly recommend standing up a [testnet](https://github.com/bitsongofficial/go-bitsong/blob/master/docs/deploy-testnet.md)
