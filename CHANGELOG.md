...
* (gaiad) [\#119](https://github.com/bitsongofficial/go-bitsong/pull/119) Add support for the `--inter-block-cache` CLI
flag and configuration.
* (gaiacli) [\#132](https://github.com/bitsongofficial/go-bitsong/pull/132) Add `tx decode` command to decode
...
* (gaiad) [\#191](https://github.com/bitsongofficial/go-bitsong/pull/191) Add debug commands to gaiad:
...
* (gaiacli) [\#191](https://github.com/bitsongofficial/go-bitsong/pull/191) Add cmd `decode-tx`, decodes a tx from hex or base64
...
* (gaiacli) [\#326](https://github.com/bitsongofficial/go-bitsong/pull/326) Implement `--offline` flag in all post commands. Some commands
...
* (gaiad) [\#119](https://github.com/bitsongofficial/go-bitsong/pull/119) Add support for the `--halt-time` CLI flag and configuration.
